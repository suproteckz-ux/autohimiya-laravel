...
class KaspiResolveWidgetUrlsHandler implements AutomationHandlerInterface
{
    public function __construct(private readonly KaspiWidgetUrlBatchResolver $service) {}
    public function handle(AutomationRun $run, AutomationProgressReporterInterface $progress, bool $dryRun = false): array
    {
        ...
        return $this->service->run($context, $progress);
    }
}