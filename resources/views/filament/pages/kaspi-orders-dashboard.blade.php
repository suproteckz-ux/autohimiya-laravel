    ...
    <div class="space-y-4">
        ...
        @if($mode === 'observe')
            <div class="rounded-lg bg-blue-50 border border-blue-200 p-4 flex items-start gap-3">
                <x-filament::icon icon="heroicon-o-eye" class="w-5 h-5 text-blue-500 mt-0.5 shrink-0" />
                <div>
        ...
        @else
            <div class="rounded-lg bg-green-50 border border-green-200 p-4 flex items-start gap-3">
                <x-filament::icon icon="heroicon-o-check-circle" class="w-5 h-5 text-green-500 mt-0.5 shrink-0" />
                <div>
        ...
        @unless($handoff_flag)
            <div class="rounded-lg bg-yellow-50 border border-yellow-200 p-4 flex items-start gap-3">
                <x-filament::icon icon="heroicon-o-exclamation-triangle" class="w-5 h-5 text-yellow-500 mt-0.5 shrink-0" />
                <div>
